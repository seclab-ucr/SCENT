...
//#include <stdio.h>
#include "TCP_Model.h"
#define VICTIM_ESTABLISHED 1 //Victim connection is established
#define ATTACKER_ESTABLISHED 0 //Attacker connection is established
...
int seq_val = 2; 
int Model0_ack_val = 2;
int Model1_ack_val = 2;
int ack_val = 2; //seq for client
...
void Pair_Difference(){
    ...
    ((struct Model1_sock *)&Model1_Server)->Model1___sk_common.Model1_skc_state = 0;
    ((struct Model1_request_sock *)&Model1_Req)->Model1___req_common.Model1_skc_state = 0;
    ...
    //If seq is different
     ...
     Model0_Server.Model0_rcv_nxt -= 1;
     Model0_Server.Model0_copied_seq -= 1;
     Model0_Server.Model0_rcv_wup -= 1;
     Model0_Server.Model0_snd_wl1 -= 1;
#elif TEST_ACK
     //If ack is different
     Model0_Port_guessed = true;
     Model1_Port_guessed = true;

     Model0_Server.Model0_snd_nxt -= 1;
     Model0_Server.Model0_snd_una -= 1; //won't be visited though
     Model0_Server.Model0_snd_up -= 1; //won't be visited though
     Model0_Server.Model0_rtt_seq -= 1;
     Model0_Server.Model0_write_seq -= 1;
#endif
...
void PreProcess(){
    ...
    printf("Model0_Server, mem allocated: %d\n", Model0_atomic_long_read(((struct Model0_sock *) &Model0_Server)->Model0___sk_common.Model0_skc_prot->Model0_memory_allocated));
...
void Execution(int pkt_depth, int pkt_index){
    ...
    printf("After each execution Model0: server_L refcnt after atomic_add_unless: %d\n", ((struct Model0_sock *)&Model0_Server_L)->Model0___sk_common.Model0_skc_refcnt);
