...
entry:
  ...
  %1 = load i16, i16* %a, align 2, !dbg !28
  %call = call i32 @get_sign(i16 signext %1), !dbg !29
  ret i32 %call, !dbg !30
}
...
!28 = !DILocation(line: 31, column: 19, scope: !21)
!29 = !DILocation(line: 31, column: 10, scope: !21)
!30 = !DILocation(line: 31, column: 3, scope: !21)
