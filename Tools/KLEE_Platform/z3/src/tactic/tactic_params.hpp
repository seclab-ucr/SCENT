...
struct tactic_params {
  ...
  static void collect_param_descrs(param_descrs & d) {
    d.insert("solve_eqs.context_solve", CPK_BOOL, "solve equalities within disjunctions.", "false","tactic");
  ...
  */
  bool solve_eqs_context_solve() const { return p.get_bool("solve_eqs.context_solve", g, false); }
